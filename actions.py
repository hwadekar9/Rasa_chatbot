...
def get_restaurants(loc, cuisine, cost, flag):
	config={ "user_key":"eead9c2c2b60cabf5326f92e6fb6860a"}
...
class SendMail(Action):
	...
	def run(self, dispatcher, tracker, domain):
		...
		s.starttls() 	
		s.login("rasafoodie31000000@gmail.com", "Youliveonly@123") 
		try:
			s.sendmail("rasafoodie31000000@gmail.com", emailId, message.encode('utf-8'))
